...
async function create_account_with_login(username, email, password) {
    ...
    await db.query(`
    INSERT INTO passwords (account_id, hash) VALUES ($1, $2);
